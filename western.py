...
csvFile = open('western.csv', 'wb')
wr = csv.writer(csvFile, quoting=csv.QUOTE_ALL)
#for i in range(1993,2016):
for num in range(1,3):
	page = urllib2.urlopen("http://www.imdb.com/search/title?genres=western&sort=user_rating,desc&title_type=feature&num_votes=25000,&pf_rd_m=A2FGELUUNOQJNL&pf_rd_p=2406822102&pf_rd_r=0QBWBE41Y9HBC8CVNSHY&pf_rd_s=right-6&pf_rd_t=15506&pf_rd_i=top&page="+str(num)+"&ref_=adv_nxt")
	#=18
...
with open('data_western.json', 'w') as outfile:
